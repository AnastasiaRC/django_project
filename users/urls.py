...
from users.views import RegisterView, ProfileView, ActivateView, VerificationSuccessView, UserPasswordResetConfirmView, \
...
urlpatterns = [
    ...
    path('password_reset/', PasswordResetView.as_view(
        ...
        subject_template_name='users/password_reset_text_email.html',
